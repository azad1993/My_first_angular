(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/testing'), require('lodash'), require('rxjs/internal/testing/HotObservable'), require('rxjs/internal/testing/ColdObservable')) :
	typeof define === 'function' && define.amd ? define(['exports', 'rxjs', 'rxjs/testing', 'lodash', 'rxjs/internal/testing/HotObservable', 'rxjs/internal/testing/ColdObservable'], factory) :
	(factory((global['jasmine-marbles'] = global['jasmine-marbles'] || {}),global.Rx,global.Rx,global._,global.rxjs_internal_testing_HotObservable,global.rxjs_internal_testing_ColdObservable));
}(this, (function (exports,rxjs,rxjs_testing,lodash,rxjs_internal_testing_HotObservable,rxjs_internal_testing_ColdObservable) { 'use strict';
...
class TestColdObservable extends rxjs.Observable {
    constructor(marbles, values, error) {
        ...
        const messages = rxjs_testing.TestScheduler.parseMarbles(marbles, values, error, undefined, true);
        const cold = new rxjs_internal_testing_ColdObservable.ColdObservable(messages, scheduler);
        this.source = cold;
...
class TestHotObservable extends rxjs.Observable {
    constructor(marbles, values, error) {
        ...
        const scheduler = getTestScheduler();
        const messages = rxjs_testing.TestScheduler.parseMarbles(marbles, values, error, undefined, true);
        const hot = new rxjs_internal_testing_HotObservable.HotObservable(messages, scheduler);
        this.source = hot;
